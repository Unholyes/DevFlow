...
export default function ProductBacklogPage({ params }: { params: { id: string } }) {
  ...
  const handleAddToSprint = () => {
    ...
    router.push(`/dashboard/projects/${params.id}/sprints/plan?tasks=${Array.from(selectedTasks).join(',')}`);
  };
