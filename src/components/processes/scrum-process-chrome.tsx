...
export function ScrumProcessChrome(props: {
  projectId: string
  phaseId: string
  processId: string
  processName: string
  ...
  const tabs: { id: ScrumProcessTab; label: string; href: string }[] = [
    { id: 'summary', label: 'Summary', href: processSummaryPath(props.projectId, props.phaseId, props.processId) },
    { id: 'sprints', label: 'Sprints', href: processSprintsPath(props.projectId, props.phaseId, props.processId) },
